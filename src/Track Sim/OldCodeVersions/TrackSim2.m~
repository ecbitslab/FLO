%% TrackSimulator (Version 2.0 Date: 3-15-12 By: Anthony Ramirez)
...
% to calibrate the accuracy of the 'BT_Drive.m' code
    ...
    %UPDATES: Version 2.0 contains gaussian noise in the positions of the
    %centroids.  This allows there to be jitters in the centroid tracks.
